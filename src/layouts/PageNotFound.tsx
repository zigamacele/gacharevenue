...
const PageNotFound: React.FC = () => {
  return (
    <section className='w-sceen h-sceen slide-from-bottom mt-4 flex items-center justify-center'>
      <div className='flex w-[90%] flex-col items-center justify-center gap-2 rounded border border-neutral-800 bg-neutral-900 px-6 py-5 sm:w-96'>
        ...
        <Link to={HOME}>
          <Button className='mt-2 flex items-center gap-1.5 bg-neutral-800'>
            <Undo2 width={16} />
            <span>Go back</span>
          </Button>
        </Link>
